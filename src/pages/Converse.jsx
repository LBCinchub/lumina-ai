...
import { PanelLeft, Download, ImageIcon, Search, FileText } from 'lucide-react';
...
export default function Converse() {
  ...
  return (
    ...
    <DocumentDialog open={docOpen} onOpenChange={setDocOpen} conversationId={activeId} messages={messages} />
    {voiceMode && (
      <LiveCallOverlay
        speaking={speaking}
        listening={listening}
